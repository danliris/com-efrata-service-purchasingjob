...
namespace Com.DanLiris.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteExpenditureFacades
{
        ...
        private List<MonitoringCorrectionNoteExpenditureViewModel> GetMonitoringKeluarNKByUserReportQuery(DateTime? dateFrom, DateTime? dateTo, int offset, int page, int size/**, string jnsBC**/)
        {
            ...
            var Query = (from
                        ...
                        n in dbContext.GarmentCorrectionNotes
                         ...
                         where
                         n != null && URN.URNType == (URN.URNType == null ? URN.URNType : "PEMBELIAN")
